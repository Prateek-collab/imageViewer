...
#Status Bar Added with rightmost anchorage.
#displays the status of image in the window
...
def forward(imgno):
                ...
                status=Label(root, text="Image "+str(imgno)+" of " + str(len(image_list)), bd=1,relief=SUNKEN, anchor=E)
